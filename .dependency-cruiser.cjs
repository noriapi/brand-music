...
module.exports = {
  forbidden: [
...

    {
      ...
      from: {},
      to: {
        path: "[.](spec|test|test-d)[.](js|mjs|cjs|ts|ls|coffee|litcoffee|coffee[.]md)$",
      },
    },
    {
      name: "not-to-dev-dep",
      ...
      from: {
        path: "^(src)",
        pathNot: [
          "[.](spec|test|test-d)[.](js|mjs|cjs|ts|ls|coffee|litcoffee|coffee[.]md)$",
          "test-utils.ts$",
        ],
      },
      to: {
...
// generated: dependency-cruiser@16.2.2 on 2024-03-01T23:14:07.679Z
